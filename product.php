...
<body>
    ...
    $resultProduct = mysqli_query($con, 'select * from product order by selled desc limit ' . $limit . ',9');
    ...
    <section class="projects py-5" id="gallery">
        <div class="container py-md-5">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <span class="announce-rating" id="annouce<?= $row['id'] ?>"></span>
                                        </div>
                                        <div class="col-md-7">
                                            ...
                                            <div class="button-quantity">
                                                ...
                                                <input id="quan<?= $row['id'] ?>" class="quantity-button1" type="number" value="1" min="1">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="pagination" style="display:block;text-align:center">
                <a href="product.php?page=1"><button><i class="fa fa-step-backward"></i></button></a>
                <?php

                for ($i = 1; $i <= $number_page; $i++) {
                    ?>
                    <a href="product.php?page=<?= $i ?>"><button><?= $i ?></button></a>
                <?php
                } ?>
                <a href="product.php?page=<?= $number_page ?>"><button><i class="fa fa-step-forward"></i></button></a>
                        ...
                        $.ajax({
                            ...
                            success: function(e) {
                                ...
                                for ($i = 0; $i < count; $i++) {
                                    ...
                                    htmlAdd += '</td>';
                                    htmlAdd += '<td>';
                                    // if (e[Object.keys(e)[$i]].quantity<1) e[Object.keys(e)[$i]].quantity=1;
