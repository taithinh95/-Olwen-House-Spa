            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="#pablo">Update Product</a>
                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="1000" max="10000000" name="productPrice" required class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Quantity</label>
                                                    <input type="number" min="1" max="1000"ame="productQuantity" required class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-8">
                                                <b>Description</b>
                                                <textarea name="productDes" placeholder="Description" id="desService" class="form-control" rows="8" required="required"></textarea>
                                                <script>
                                                    var config = {};
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="file" name="file[]" class="filestyle" data-classButton="btn-white" data-input="true" data-classIcon="icon-plus" multiple data-buttonText="sadasda">
                                            </div>
                                        </div>
