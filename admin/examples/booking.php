                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title ">BOOKING MANAGEMENT TABLE</h4>
                                </div>
                                <div class="card-body">
                                    <table class="stripe" style="width:100%;" id="productTable">
                                        <thead>
                                            ...
                                            <th>
                                                SERVICE INFORMATION (NAME, PRICE)
                                            </th>
                                            <th>
                                                PHONE
                                            </th>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                $result_price = mysqli_query($con, "select * from service where id='" . $row['serviceId'] . "'");
                                                $row_price = mysqli_fetch_assoc($result_price);
                                                $stringDate=$row['bookingTime'];
                                                ?>
                                                <tr style="font-weight:bold">
                                                    <td><?= $row['bookingTime'] ?></td>
                                                    <td>
                                                        <?= $row['service_name'] . " (" . $row_price['price'] . " VND)" ?>
                                                    </td>
                                                    <td>
                                                        0<?= $row['phone'] ?>
                                                    </td>
